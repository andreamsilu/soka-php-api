 ...
 * the same JSON + header format used for SMS (see register.php).
 */
...
// Build JSON payload for upstream API, mirroring SMS format
$payload = json_encode([
    'MSISDN' => $msisdn,
]);
...
$opts = [
    'http' => [
        ...
        'header'  =>
            ...
            // Match Postman / SMS header name exactly: "securitykey"
